...
CREATE TABLE attempts ( id serial NOT NULL, ip character varying(39) NOT NULL, expiredate datetime(6) NOT NULL, PRIMARY KEY (id) );
...
CREATE TABLE users (
  ...
  isactive decimal(38) NOT NULL DEFAULT '0',
  dt datetime(6) NOT NULL DEFAULT NOW(),
  PRIMARY KEY (id)
);
